...
const Page = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response: AxiosResponse = await axios.post('/api/verifyDoctorOTP', { email, otp });
      ...
      if (response.status === 201) {
        ...
        toast({
          title: "OTP verification completed successfully.",
          description: "Login Token sent to your email.",
        });
        router.push('/loginDoctor');  // Redirect after successful verification
      }
